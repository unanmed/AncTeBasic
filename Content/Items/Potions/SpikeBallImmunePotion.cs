...
public class SpikeBallImmunePotion : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.buffType = ModContent.BuffType<Buffs.SpikeBallImmuneBuff>(); // Specify an existing buff to be applied when used.
